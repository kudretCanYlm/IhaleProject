...
using IhaleProject.Models.TokenAuth;
...
{
    public abstract class IhaleProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IhaleProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IhaleProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IhaleProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IhaleProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IhaleProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IhaleProjectDbContext, Task<T>> func)
        {
            T result;
